...
def test_resolve_channel_mapping() -> None:
    assert data_management.resolve_channel({"source_type": "dukascopy"}, "auto") == "Neon"
    assert data_management.resolve_channel({"source_type": "databento"}, "auto") == "Databento"
    assert data_management.resolve_channel({"source_type": "binance_public"}, "auto") == "Neon"
    assert data_management.resolve_channel({"source_type": "mt5"}, "auto") == "Neon"
